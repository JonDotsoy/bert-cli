    ...
    return new Promise((resolve, reject) => {
      ...
      proc.on('exit', (code, signal) => {
        ...
        if (code === 0) {
          ...
          const error = Object.assign(new Error(`Process close with ${code} code. ${tr&&(`${tr.getFileName()}:${tr.getLineNumber()}:${tr.getColumnNumber()}`)}`, tr.getFileName(), tr.getLineNumber()), {code, signal})
