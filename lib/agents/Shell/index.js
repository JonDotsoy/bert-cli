  ...
  async sh (args, opts = {}, tr) {
    ...
    return new Promise((resolve, reject) => {
      ...
      proc.stdout.on('data', function (data) {
        ...
        stdallcollection.push.call(stdallcollection, data)

        if (!spawnOpts.silent) process.stdout.write.call(process.stdout, data)
      })

      proc.stderr.on('data', function (data) {
        stderrcollection.push.call(stderrcollection, data)
        stdallcollection.push.call(stdallcollection, data)

        if (!spawnOpts.silent) process.stderr.write.call(process.stderr, data)
      })
